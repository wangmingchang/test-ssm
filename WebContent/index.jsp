	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
	  <div id="" class="container">
	  	<div class="navbar-header">
	    	<a class="navbar-brand" href="javascript:void(0)"><img src="${pageContext.request.contextPath }/publicResources/images/index/logo.png"/></a>
        </div>
	  	<div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="navbar-link"><a href="javascript:void(0)">首页</a></li>
